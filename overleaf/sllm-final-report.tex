...
overhead, the worst-case configuration. See Appendix \ref{app:mtron-impl-detail-pp} for more details about 
pipeline parallelism in Megatron and how microbatches affect the bubble overhead.
...
\subsection{Pipeline Parallelism}\label{app:mtron-impl-detail-pp}
